...
from blog.models import Article, Tag, Comment, User, AnswerLike, QuestionLike, Profile
...
class Command(BaseCommand):
    ...
    def generate_question_to_tags_link(self):
        ...
        for question in Article.objects.all():
    ...
    def generate_questions(self):
        ...
        Article.objects.bulk_create(questions)
